    ...
    return (
        <div className="card">
            ...
            <div className="card-body">
                {props.article.articleTitle && <a target={window.innerWidth > 100 ? '_blank' : '_self'} href={`${props.article.articleUrl}`} rel="noreferrer noopener" onClick={() => addClickCount(props.article.dbid,props.article.whichcontinent)}>
